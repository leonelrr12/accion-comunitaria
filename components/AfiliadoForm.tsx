...
// Formulario compartido de registro de afiliados.
// - Dashboard (líderes): líder por defecto = el usuario actual
// - Panel ADMIN: el líder se elige obligatoriamente
...
export default function AfiliadoForm({ defaultLeaderId = "", redirectTo, title = "Registrar Nuevo Afiliado" }: AfiliadoFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!formData.phone) {
            toast.warning("El teléfono o celular es obligatorio.");
            return;
        }
            ...
            <div className="md:flex md:items-center md:justify-between">
                <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Completa los datos del simpatizante. La ubicación se hereda del líder seleccionado.
                    </p>
                </div>
            </div>
                ...
                <form className="space-y-8 divide-y divide-gray-100" onSubmit={handleSubmit}>
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                <label className="block text-sm font-semibold text-slate-700 mb-1.5">Teléfono / Celular <span className="text-red-500">*</span></label>
                                <input
                                    type="tel"
                                    required
                                    disabled={isPending}
