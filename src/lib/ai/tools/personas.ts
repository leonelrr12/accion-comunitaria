...
export const crearPersona: Tool = {
  ...
  parameters: z.object({
    ...
    province_id: z.number().optional().describe('ID de la provincia'),
    district_id: z.number().optional().describe('ID del distrito'),
    corregimiento_id: z.number().optional().describe('ID del corregimiento'),
  ...
  execute: async (args) => {
    ...
    const persona = await prisma.person.create({
      data: {
        ...
        provinceId: args.province_id as number | undefined,
        districtId: args.district_id as number | undefined,
        corregimientoId: args.corregimiento_id as number | undefined,
