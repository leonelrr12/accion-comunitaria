...
export default function NuevoAfiliado() {
    ...
    const [formData, setFormData] = useState({
        ...
        email: "",
        address: "",
        provinceId: currentUser?.provinceId?.toString() || process.env.NEXT_PUBLIC_DEFAULT_PROVINCE_ID || "8",
        districtId: currentUser?.districtId?.toString() || process.env.NEXT_PUBLIC_DEFAULT_DISTRICT_ID || "2",
